...
<head>
    ...
    <title>PRINT LAPORAN PRODUKSI PERMINGGU</title>
...
<body onLoad="window.print()">
    ...
    <div style="text-align: center; ">
        <font size="3"><b><u>LAPORAN DATA PRODUKSI <br> <?php echo strtoupper(tgl_indo($tgl1));?> s/d <?php echo strtoupper(tgl_indo($tgl2));?></u></b></font><br>
    </div>
    <br>
        ...
        <thead style="background-color: #d5eacf; text-align: center; ">
                                   <tr>
                                            ...
                                            <tbody style="text-align: center;">
                                                <?php $no=1; $t_berat_kosongan=0; $t_berat_kotor=0; $t_berat_bersih=0; foreach ($data_produksi->result_array() as $i) :
                                                    $id_produksi=$i['id_produksi'];
                                                $berat_bersih=$i['berat_kotor']-$i['berat_kosongan'];
                                                $t_berat_kosongan=$t_berat_kosongan+$i['berat_kosongan'];
                                                $t_berat_kotor=$t_berat_kotor+$i['berat_kotor'];
                                                $t_berat_bersih=$t_berat_bersih+$berat_bersih;
                                                  ?>
                                                 <tr>
            ...
            <?php endforeach ?>
                        ...
                        <tr>
                                                ...
                                                <td style="flex: 0 0 auto; min-width: 2em;" colspan="11">TOTAL</td>
                                                <td><?php echo $t_berat_kosongan;?></td>
                                                <td><?php echo $t_berat_kotor;?></td>
                                                <td><?php echo $t_berat_bersih;?></td>
                                                <td colspan="3"></td>
