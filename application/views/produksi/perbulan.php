...
<head>
    ...
    <title>PRINT LAPORAN PRODUKSI PERBULAN</title>
...
<body onLoad="window.print()">
    ...
    <div style="text-align: center; ">
        <font size="3"><b><u>LAPORAN DATA PRODUKSI <br> TAHUN <?php echo strtoupper($tahun);?> BULAN <?php echo strtoupper($bulan);?></u></b></font><br>
    </div>
    <br>
